...
<section class="card">
    ...
    <?php endif; ?>
    <form method="post" action="/admin/signals/save" class="form-grid">
        <?php if ($signal): ?>
        ...
        <div class="note" data-available-symbols='<?= json_encode($availableSymbols, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>'>
